...
$(document).ready(function () {
  ...
  $.checkSiteRTLDirection = function () {
    ...
    var checkDir = dir !== undefined ? dir.toLocaleLowerCase() : "";
    var rtl = checkDir == "rtl";
    return rtl;
  };
  if ($.fn.slick) {
    ...
    instances.each(function (idx, instance) {
      slickEditor =
        $(instance).data("slick-editor") == undefined ||
        $(instance).data("slick-editor");

      if (!editorMode || (slickEditor && editorMode)) {
        var rtl = $.checkSiteRTLDirection();

        // Getting items responsive count
        var childs = $(instance).hasClass("slick-initialized")
            ? $(instance).slick("getSlick").slideCount
        ...
        // infinite
        var infinite = $(instance).data().hasOwnProperty("infinite")
            ? $(instance).data("infinite")
            : true,
        ...
        // initial slide
        var initialslide = $(instance).data().hasOwnProperty("initialslide")
            ? $(instance).data("initialslide")
            : 0,
        ...
        var autoplay =
          !!(
            $(instance).data().hasOwnProperty("autoplay") &&
            $(instance).data("autoplay") != "" &&
            !!$(instance).data("autoplay")
          ) && !editorMode;
        ...
        var prevArrow = $(instance).parent().find("[aria-label='prev']").length
            ? $(instance).parent().find("[aria-label='prev']")
            : "." + $(instance).data("prev-arrow"),
          nextArrow = $(instance).parent().find("[aria-label='next']").length
            ? $(instance).parent().find("[aria-label='next']")
            : "." + $(instance).data("next-arrow");
          ...
          $(_this)
            ...
            .css(
              ...
              "calc(" +
                biggestItemHeight +
                "px - (" +
                items.css("border-bottom-width") +
                " + " +
                items.css("border-top-width") +
                "))"
            );
          $(_this)
        ...
        var unslickInstance =
          window.innerWidth <= 767
            ? ".js-slick-mobile-disabled"
            : ".js-slick-mobile-enabled";
        $(instance)
          .not(".slick-initialized, " + unslickInstance)
          .slick({
            dots: enableDots,
            arrows: enablearrows,
            ...
            responsive: [
              {
                ...
                settings: {
                  ...
                  centerPadding:
                    centerPaddinglg &&
                    (rtl ? "0 0 " + centerPaddinglg : centerPaddinglg + " 0 0"),
                },
              },
              {
                breakpoint: 813,
                settings: {
                  ...
                  centerPadding:
                    centerPaddingmd &&
                    (rtl ? "0 0 " + centerPaddingmd : centerPaddingmd + " 0 0"),
                },
              },
              {
                breakpoint: 386,
                settings: {
                  ...
                  centerPadding:
                    centerPaddingsm &&
                    (rtl ? "0 0 " + centerPaddingsm : centerPaddingsm + " 0 0"),
                },
              },
              {
              ...
              },
              {
                ...
                settings: {
                  ...
                  centerPadding:
                    centerPaddingxs &&
                    (rtl ? "0 0 " + centerPaddingxs : centerPaddingxs + " 0 0"),
                },
              },
            ],
          });
